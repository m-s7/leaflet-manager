...
import { createMarkerManager } from './map/marker/marker-manager'
import { createControlManager } from './map/control/control-manager'

export type MapManagerActions = {
...
export const createMapManager = (map: Map, center: LatLngExpression = [0, 0], zoom = 15): MapManagerActions => {
